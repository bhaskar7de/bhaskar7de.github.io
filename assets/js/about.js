...
(function () {
  ...
  var STOPS = [
    {
      ...
      cards: [
        ...
        },
        {
          ...
          institution: "RKMRC Narendrapur",
          city: "Kolkata",
          country: "India",
          desc: "B.Sc. in Physics. First deep exposure to optics, quantum mechanics, and wave phenomena.",
        },
        {
          bgClass: "tl-bg-inspire",
          badge: "tl-badge-award",
          badgeText: "Award",
          years: "2015 \u2013 2020",
          institution: "INSPIRE Scholarship",
          city: "Department of Science & Technology",
      ...
      cards: [
        {
          ...
          badgeText: "Award",
          years: "2019",
          institution: "CSIR National Eligibility Test",
          city: "Council of Scientific and Industrial Research",
          country: "India",
      ...
      cards: [
        {
          ...
          badge: "tl-badge-edu",
          years: "2020 \u2013 2021",
          degree: "PhD in Physics, CSIR Junior Research Fellow",
          institution:
      ...
      cards: [
        {
          ...
          years: "2021",
          institution: "Prime Minister\u2019s Research Fellowship",
        ...
        {
          bgClass: "tl-bg-iiserpmrf",
          badge: "tl-badge-edu",
          years: "2021 \u2013 2026",
          degree: "PhD in Physics, PMRF Fellow",
          institution:
            "Indian Institute of Science Education and Research (IISER) Bhopal",
          city: "Bhopal",
          country: "India",
  ...
  var firstYear = STOPS.reduce(function (m, s) {
    return Math.min(m, s.year);
  }, Infinity);
  var lastYear = STOPS.reduce(function (m, s) {
    return Math.max(m, s.year);
  }, -Infinity);
  ...
  function buildBgs() {
    CARDS.forEach(function (card, i) {
      ...
      div.id = "tlbg" + i;
      if (i === 8) div.classList.add("tl-bg-visible");
  ...
  function renderCard(idx) {
    ...
    elContent.innerHTML =
      (card.badgeText
        ? '<div class="tl-badge ' +
          ...
          "</div>"
        : "") +
      '<div class="tl-card-years">' +
      card.years +
      "</div>" +
      '<div class="tl-card-institution">' +
      card.institution +
      "</div>" +
      '<div class="tl-card-degree">' +
      (card.degree || "") +
      "</div>" +
    ...
    var ad = document.getElementById(
      "tldot" + card.stopIdx + "_" + card.cardInStop,
    );
  ...
  function goTo(idx, dir) {
    ...
    newBg.style.transform = fwd
      ? "translateX(2%) scale(1.04)"
      : "translateX(-2%) scale(1.04)";
